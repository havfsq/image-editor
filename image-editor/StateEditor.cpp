...
{
	// Главное меню окна (Файл..Импорт..Экспорт..)
...
#pragma endregion
	...
	// Настройки текущего окна ImGui
#pragma region widowSettings
...
#pragma endregion
		...
		// Список инстурментов / Эффектов
#pragma region Column1
		ImGui::Text("Hello");
		ImGui::Button("Banana");
		ImGui::NextColumn();
#pragma endregion
		// Колонка вывода анимации на экран
#pragma region Column2
		...
		ImGui::NextColumn();
#pragma endregion
		// Список настроек анимации
#pragma region Column3
		ImGui::Text(u8"Кадры"); ImGui::Text(u8"Кадры"); ImGui::Text(u8"Кадры");
		ImGui::Spacing();

		// Рисуем Разделитель (Горизонтальную Линию)
		ImDrawList*   draw_list = ImGui::GetWindowDrawList();
		ImVec2 p = ImGui::GetCursorScreenPos();
		draw_list->AddLine(ImVec2(p.x - 9999, p.y), ImVec2(p.x + 9999, p.y), ImGui::GetColorU32(ImGuiCol_Column));

		ImGui::Text(u8"Кадры");
		ImGui::SliderFloat(u8"Длина Кадра", &this->imageManager->animationDeley, 0.0f, 0.5f);
			
		// Кропки Запуска/Остановки Анимации
#pragma region playstopButtons
...
#pragma endregion
		...
		// Кнопки Удилание/Добавления Фреймов (Текстуры)
#pragma region addRemodeFrameButtons
		...
		{
			this->imageManager->createTexture();
		}
		
#pragma endregion

		// Кропки выбора фреймов
#pragma region framesButtons
...
#pragma endregion
		...
		{
			this->imageManager->saveAnitaionToFile("bwgif.gif", this->imageManager->animationDeley);
		}
	}
	ImGui::End();
